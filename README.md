...
**Метрики**: точность `setting` и пересечение `mood` — ловят,
...
**Baseline** (30 лупов, `evals/runs/20260920T125514_56840b8.json`.
...
Фильтры и реранк не улучшают retrieval на текущем промпте — отсюда
