...
# Библиотека сбалансирована точно (по 100 треков на жанр, см. README) — у
# short-описаний ниже задача отучить 4B-модель от дефолта на electronic
# (в измерении на 30 лупов он был выбран в 12+ случаях без статистической
# причины) и дать за что зацепиться помимо самого названия жанра.
